...
let textQuestions = [
  {
    number: 10,
    text: "Я читал книгу, когда ты позвонил(to call)",
    right: "I was reading a book when you called",
  },
  {
    number: 11,
    text: "Они играли в футбол, когда пошел(to start) дождь",
    right: "They were playing football when it started raining",
  },
  {
    number: 12,
    text: "Что ты делал вчера в 7 вечера (7 PM) ?",
    right: "What were you doing at 7 PM yesterday ?",
  },
  {
    number: 13,
    text: "Она готовила(to cook) ужин, пока он смотрел телевизор",
    right: "She was cooking dinner while he was watching TV",
  },
  {
    number: 14,
    text: "Мы не спали, когда начался(to begin) шторм",
